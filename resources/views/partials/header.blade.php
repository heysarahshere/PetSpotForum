<header id="header" class="no-fouc" style="z-index: 9999">

   <nav class="navbar navbar-expand-sm navbar-dark p-0" id="nav_bar" style="font-weight: lighter; pointer-events: auto;">
        ...
        <div class="collapse navbar-collapse w-100 py-3 px-2 py-sm-0" id="navbarSupportedContent" style="z-index: 1000; color: white; background-color: black;">
            <ul class="navbar-nav m-auto" id="navbar_list w-100">
                ...
                <li class="nav-item">
                    <a class="nav-link"  id="projects_link" href="{{route('home')}}#projects">PROJECTS</a>
                </li>
                <li class="nav-item">
